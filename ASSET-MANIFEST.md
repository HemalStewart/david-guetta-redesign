...
| Hero loop (active) | `hero/hero-loop.mp4` + `.webm` + `-poster.jpg` | **Original**, generated by `tools/make-hero-loop.py` | 1920 × 1080, 8 s, no audio track | approved (we made it) | Replace with approved stage footage when available |
...
### The hero loop is original, not lifted footage
